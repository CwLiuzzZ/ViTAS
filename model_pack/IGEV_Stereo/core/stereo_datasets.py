...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='../../datasets/KITTI', image_set='testing'):
        ...
        disp_list = sorted(glob(os.path.join(root_12, 'training', 'disp_occ/*_10.png'))) if image_set == 'training' else [osp.join(root, '2012/training/disp_occ/000085_10.png')]*len(image1_list)
        ...
        disp_list += sorted(glob(os.path.join(root_15, 'training', 'disp_occ_0/*_10.png'))) if image_set == 'training' else [osp.join(root, '2015/training/disp_occ_0/000085_10.png')]*len(image1_list)
