...
from ModelCreated.ViTAS.ViTAS_module.Uni_CA.position import PositionEmbeddingSine
...
def split_feature(feature,
    ...
    if channel_last:  # [B, H, W, C]
        ...
        assert h % num_splits == 0 and w % num_splits == 0, feature.shape
...
def feature_add_position_cross_feature(feature0, feature1, feature0_high, feature1_high,feature_channels,feature_channels_high):
    pos_enc = PositionEmbeddingSine(num_pos_feats=feature_channels // 2)
    position = pos_enc(feature0)
    pos_enc_high = PositionEmbeddingSine(num_pos_feats=feature_channels_high // 2)
    position_high = pos_enc_high(feature0_high)
    feature0 = feature0 + position
    feature1 = feature1 + position
    feature0_high = feature0_high + position_high
    feature1_high = feature1_high + position_high
    return feature0, feature1, feature0_high, feature1_high
